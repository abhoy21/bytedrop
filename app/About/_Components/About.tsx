              ...
              <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                  ...
                  <p className="text-base text-gray-700">
                    ByteDrop revolutionizes file sharing with its seamless web
                    application. Effortlessly transfer files of any size
                    securely and swiftly, ensuring efficient collaboration and
                    communication among teams and individuals. Experience the
                    ease of sharing documents, images, videos, and more with
                    ByteDrop.
                  </p>
                  <div className="mt-10 flex flex-col items-center md:flex-row">
                    <a
                      href="/"
                      className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-purple-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-500 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                    >
                      View More
                    </a>
                    <a
