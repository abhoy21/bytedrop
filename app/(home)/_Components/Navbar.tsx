...
const Navbar = () => {
  ...
  useEffect(() => {
    const randomIndex = Math.floor(Math.random() * Profileimg.length);
  ...
  return (
    <>
      <nav className="relative px-4 py-4 flex justify-between items-center bg-transparent">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-autolg:items-center lg:w-auto lg:space-x-6">
          <li>
            <Link
        ...
        <div className="h-12 w-12 md:h-16 md:w-16 overflow-hidden rounded-full ring-2 ring-gray-700 dark:ring-gray-100">
